...
INSERT INTO shopuser (id, phone, password, first_name, last_name, email) VALUES ('6b718067-e1e4-4202-a7e2-7339ea0d6cb4', 'anonymous', '{noop}anonymous', 'anonymous', 'anonymous', 'anonymous@supershop.com');
INSERT INTO shopuser (id, phone, password, first_name, last_name, email) VALUES ('fbe5a8e7-8555-4ee8-bff2-c572447e5f25', '11111111', '$2a$10$XXc06MnLKagghrYAaTDDHO0k9MmNvS/H8mAMXiLGdXHJgL4L/7wEq', 'Admin', 'Admin', 'admin@supershop.com');
INSERT INTO shopuser (id, phone, password, first_name, last_name, email) VALUES ('04c8bd30-ba4e-4e82-b996-db907e37a2c6', '22222222', '$2a$10$mfXWbhe0bbgVDbYNX6CsrOFm3Whm2.d8MfM6/gB8widMy.HE2DsDS', 'User', 'User', 'user@supershop.com');
...
INSERT INTO role (id, name, description) VALUES (1, 'ROLE_ADMIN', null);
INSERT INTO role (id, name, description) VALUES (2, 'ROLE_CUSTOMER', null);
